...
flat out float vAlpha;  // per-instance multiplier: scales alpha for rings/enemies; scales radius for nations
flat out float vRadius; // per-instance quad radius (KIND_NATION: base + RADIUS_MARGIN, scaled by vAlpha)
